...
describe('', () => {
  ...
  it('interpolate length', () => {
    ...
    expect(model['2']).toEqual({
      label: 'interpolated-2',
      distance: 2,
      elevations: [12, 22]
    })
    expect(model['8']).toEqual({
      label: 'interpolated-8',
      distance: 8,
      elevations: [18, 28]
    })
    expect(model['10']).toEqual({
      label: 'item10m',
      distance: 10,
      elevations: [20, 30]
    })
  ...
  it('interpolate width', () => {
    ...
    expect(model['0']).toEqual({
      label: 'item0m',
      distance: 0,
      elevations: [10, 12.5, 15, 17.5, 20]
    })
    expect(model['10']).toEqual({
      label: 'item10m',
      distance: 10,
      elevations: [20, 22.5, 25, 27.5, 30]
    })
  })
  ...
  it('extrapolate width', () => {
    ...
    expect(model['0']).toEqual({
      label: 'item0m',
      distance: 0,
      elevations: [10, 10, 20, 20]
    })
    expect(model['10']).toEqual({
      label: 'item10m',
      distance: 10,
      elevations: [20, 20, 30, 30]
    })
  })
